    ...
    return (
        <div className="bg-brand-amber py-3 border-y border-brand-charcoal/5">
            <div className="container flex items-center justify-center gap-3 text-center">
                ...
                <p className="text-sm font-[800] text-brand-charcoal tracking-tight">
                    53 SPOTS LEFT for 2025-2026 school year.{" "}
                    <span className="font-medium opacity-80">After that, these kids wait another year&mdash;or drop out permanently.</span>
                </p>
            </div>
        </div>
    );
